...
Google Drive: https://drive.google.com/file/d/15H-By3dl8V-Xw-HMRibBXWR5jaI__7pd/view?usp=sharing <br />
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| DySSNet  | 23.28 | 4.23 | 89.53% | [Link](https://drive.google.com/file/d/1Nv6B6w4lisblfKKlOC8_xrWghF-6oCBu/view?usp=sharing) |


The ImageNet-1K pretrained weight that is used to train the DySSNet is also found in the pretrained weight folder of this repository or can be downloaded via this [Link](https://drive.google.com/file/d/18NEYI8mC9ueOqT9g-0OQk8TSRy_Xf58p/view?usp=sharing).
